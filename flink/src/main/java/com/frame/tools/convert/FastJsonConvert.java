...
public interface FastJsonConvert extends JsonConvert {
    ...
    default byte[] toJSONByte(Object o) {
        return JSON.toJSONBytes(o, SerializerFeatureSetting.SERIALIZER_FEATURES);
    }
    ...
    default String toJSONString(Object o) {
        return JSON.toJSONString(o, SerializerFeatureSetting.SERIALIZER_FEATURES);
    }
    ...
    default String toJSONPrettilyString(Object o) {
        return JSON.toJSONString(o, SerializerFeatureSetting.SERIALIZER_PRETTILY_FEATURES);
    }
